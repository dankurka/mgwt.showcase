...
public class UIEntrySelectedEvent extends Event<UIEntrySelectedEvent.Handler> {
	...
	public enum UIEntry {
		BUTTON_BAR, BUTTONS, ELEMENTS, POPUPS, PROGRESS_BAR, PROGRESS_INDICATOR, PULL_TO_REFRESH, SCROLL_WIDGET, SEARCH_BOX, SLIDER, TABBAR, FORMS, CAROUSEL, CAROUSEL_VERT
	}
